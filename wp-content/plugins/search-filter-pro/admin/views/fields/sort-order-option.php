	...
	<fieldset class='sort-options-advanced'>
		...
		<p class='item-container slimx2'>
			...
			<label for="{0}[{1}][meta_key]">
				<?php _e("Meta Key: ", $this->plugin_slug); ?><span class="hint--top hint--info" data-hint="<?php _e("choose a meta key for sort by", $this->plugin_slug); ?>"><i class="dashicons dashicons-info"></i></span> 
				<?php
