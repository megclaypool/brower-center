...
<script type="text/javascript" src='/files/brower_front/slide.js'></script>
...
// echo('<br />');
	...
	{
		$image_keys = array_keys( $node->files);
		if ( count( $image_keys) > 0)
		{
			$big_image = $node->files[$image_keys[rand(0, count( $image_keys) - 1)]];
		}
	}
	if ( isset($big_image))
	{

print '<div id="slideshow" style="width:774px;height:294px;"></div>';


	}
	print $content;
	if ( isset($big_image)) print('</div>');
?>
        </div>
